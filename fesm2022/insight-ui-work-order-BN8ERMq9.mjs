...
import { of } from 'rxjs';
import { IDialogRef, I_DIALOG_DATA, IUI, IDialog, IGrid, IGridColumn, ISection, ISectionBody, IDialogService, IFCInput, ISelect, IAlertService, IGridDataSource, IButton, IFCDatepicker, IGridCustomColumn, IGridCellDefDirective, IGridCell, ISectionHeader, ISectionFilter } from './insight-ui.mjs';
...
class LocationTable {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.16", type: LocationTable, isStandalone: true, selector: "ir-location-table", ngImport: i0, template: "<i-dialog title=\"Create Request\" (onSave)=\"onSave()\">\n  <i-section>\n    <i-section-body class=\"p-0\">\n      <i-grid\n        class=\"p-0\"\n        selectionMode=\"multiple\"\n        [dataSource]=\"treeData\"\n        [showNumberColumn]=\"true\"\n        [tree]=\"'children'\"\n        [treeInitialExpandLevel]=\"2\"\n        (selectionChange)=\"onSelectionChange($event)\"\n      >\n        <i-grid-column fieldName=\"name\" label=\"Name\" width=\"fill\" [freeze]=\"true\" />\n      </i-grid>\n    </i-section-body>\n  </i-section>\n</i-dialog>\n", styles: [""], dependencies: [{ kind: "ngmodule", type: IUI }, { kind: "component", type: IDialog, selector: "i-dialog", inputs: ["title", "actions"], outputs: ["onOk", "onConfirm", "onSave", "onCustomAction"] }, { kind: "component", type: IGrid, selector: "i-grid", inputs: ["dataSource", "selectionMode", "tree", "treeIndent", "treeColumn", "treeInitialExpandLevel", "showNumberColumn"], outputs: ["onSelectionChange", "onRowClick", "onRowExpandChange", "onExpandedRowsChange"], exportAs: ["iGrid"] }, { kind: "component", type: IGridColumn, selector: "i-grid-column", inputs: ["fieldName", "title", "sortable", "resizable", "width", "freeze"] }, { kind: "component", type: ISection, selector: "i-section" }, { kind: "component", type: ISectionBody, selector: "i-section-body" }] });
}
    ...
    openDialog = () => {
        ...
        locationDialogRef.afterClosed().subscribe((result) => {
            if (result) {
                ...
                const firstItem = result.data.selected.map((x) => x.name).join(', ');
...
export { WorkOrder };
//# sourceMappingURL=insight-ui-work-order-BN8ERMq9.mjs.map
