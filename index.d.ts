...
import { EventEmitter, OnInit, TemplateRef, AfterContentInit, AfterViewChecked, OnDestroy, ElementRef, InjectionToken, Type, OnChanges, Injector, SimpleChanges, QueryList, PipeTransform } from '@angular/core';
 ...
 * Version: 1.5.3
 */
declare class IFCDatepicker implements ControlValueAccessor, OnDestroy {
...
declare const I_PILL_ICON_SIZES: {
    '2xs': string;
    xs: string;
    sm: string;
    md: string;
...
type IPillIconSize = keyof typeof I_PILL_ICON_SIZES;
