...
import { EventEmitter, Type, InjectionToken, OnChanges, Injector, SimpleChanges, OnInit, ElementRef, TemplateRef, AfterContentInit, OnDestroy, ChangeDetectorRef, NgZone, QueryList, PipeTransform } from '@angular/core';
...
declare class ICodeViewer {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ICodeViewer, "i-code-viewer", never, { "title": { "alias": "title"; "required": false; }; "language": { "alias": "language"; "required": false; }; "file": { "alias": "file"; "required": false; }; "code": { "alias": "code"; "required": false; }; "copy": { "alias": "copy"; "required": false; }; "lineNumbers": { "alias": "lineNumbers"; "required": false; }; "wrap": { "alias": "wrap"; "required": false; }; "compact": { "alias": "compact"; "required": false; }; "scroll": { "alias": "scroll"; "required": false; }; "height": { "alias": "height"; "required": false; }; "highlighter": { "alias": "highlighter"; "required": false; }; }, { "fileLoaded": "fileLoaded"; }, never, never, true, never>;
