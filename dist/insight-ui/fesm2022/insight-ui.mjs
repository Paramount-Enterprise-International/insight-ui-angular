...
import { NgClass, NgComponentOutlet, NgStyle, AsyncPipe, CommonModule, formatDate, NgTemplateOutlet } from '@angular/common';
...
class IIcon {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: IIcon, isStandalone: true, selector: "i-icon", inputs: { icon: "icon", size: "size" }, ngImport: i0, template: `<i [ngClass]="iconClass"></i>`, isInline: true, dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] });
}
...
class IDialogOutlet {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: IDialogOutlet, isStandalone: true, selector: "i-dialog-outlet", ngImport: i0, template: `
...
class IAlert {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: IAlert, isStandalone: true, selector: "i-alert", ngImport: i0, template: "<i-dialog\n  [actions]=\"[\n    {\n      type: 'ok',\n      className: 'w-full'\n    }\n  ]\"\n  [ngClass]=\"alertClass\"\n  (onOk)=\"submit()\"\n>\n  @if(data.type === 'information') {\n  <i-icon icon=\"info\" size=\"3xl\" />\n  } @if(data.type === 'success') {\n  <i-icon icon=\"check-circle\" size=\"3xl\" />\n  } @if(data.type === 'warning') {\n  <i-icon icon=\"exclamation\" size=\"3xl\" />\n  } @if(data.type === 'danger') {\n  <i-icon icon=\"x-circle\" size=\"3xl\" />\n  }\n  <h4>{{ data.title }}</h4>\n  <p [innerHtml]=\"data.description\"></p>\n</i-dialog>\n", dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "component", type: IIcon, selector: "i-icon", inputs: ["icon", "size"] }, { kind: "component", type: IDialog, selector: "i-dialog", inputs: ["title", "actions", "actionAlign"], outputs: ["onOk", "onConfirm", "onSave", "onCustomAction"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IAlert, decorators: [{
            type: Component,
            args: [{ selector: 'i-alert', imports: [NgClass, IIcon, IDialog], template: "<i-dialog\n  [actions]=\"[\n    {\n      type: 'ok',\n      className: 'w-full'\n    }\n  ]\"\n  [ngClass]=\"alertClass\"\n  (onOk)=\"submit()\"\n>\n  @if(data.type === 'information') {\n  <i-icon icon=\"info\" size=\"3xl\" />\n  } @if(data.type === 'success') {\n  <i-icon icon=\"check-circle\" size=\"3xl\" />\n  } @if(data.type === 'warning') {\n  <i-icon icon=\"exclamation\" size=\"3xl\" />\n  } @if(data.type === 'danger') {\n  <i-icon icon=\"x-circle\" size=\"3xl\" />\n  }\n  <h4>{{ data.title }}</h4>\n  <p [innerHtml]=\"data.description\"></p>\n</i-dialog>\n" }]
        }] });
class IAlertService {
...
class ICard {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: ICard, isStandalone: true, selector: "i-card", inputs: { href: "href", routerLink: "routerLink", queryParams: "queryParams", fragment: "fragment", replaceUrl: "replaceUrl", skipLocationChange: "skipLocationChange", state: "state", target: "target", rel: "rel", disabled: "disabled" }, outputs: { cardClick: "cardClick" }, ngImport: i0, template: `
    @if (useRouterLink) {
    <a
      class="i-card"
...
class ICardImage {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: ICardImage, isStandalone: true, selector: "i-card-image", inputs: { src: "src" }, ngImport: i0, template: `<img alt="card-image" [src]="src" />`, isInline: true });
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IConfirm, decorators: [{
            type: Component,
            args: [{ selector: 'i-confirm', imports: [IDialog, NgClass, IIcon, IFCTextArea, ReactiveFormsModule, FormsModule], template: "<i-dialog\n  actionAlign=\"center\"\n  [actions]=\"[\n    {\n      type: 'confirm',\n      className: 'w-104',\n    },\n    {\n      type: 'cancel',\n      className: 'w-104',\n    },\n  ]\"\n  [ngClass]=\"confirmClass\"\n  (onConfirm)=\"submit()\"\n>\n  @if (data.type === 'information') {\n  <i-icon icon=\"info\" size=\"3xl\" />\n  } @if (data.type === 'success') {\n  <i-icon icon=\"check-circle\" size=\"3xl\" />\n  } @if (data.type === 'warning') {\n  <i-icon icon=\"exclamation\" size=\"3xl\" />\n  } @if (data.type === 'danger') {\n  <i-icon icon=\"x-circle\" size=\"3xl\" />\n  }\n  <h4>{{ data.title }}</h4>\n  <p [innerHtml]=\"data.description\"></p>\n  @if (data.reason) {\n  <form class=\"mt-xs\" [formGroup]=\"formGroup\" (ngSubmit)=\"onSubmit()\">\n    <i-fc-textarea\n      formControlName=\"reason\"\n      label=\"Reason\"\n      placeholder=\"Fill your reason here..\"\n      [errorMessage]=\"{\n          required: 'Please fill in the reason..',\n        }\"\n    />\n    <button #submitButton class=\"hidden\" type=\"submit\">Submit</button>\n  </form>\n  }\n</i-dialog>\n" }]
...
class IDatepicker {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IDatepicker, deps: [], target: i0.ɵɵFactoryTarget.Component });
...
class IFCDatepicker {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IFCDatepicker, deps: [], target: i0.ɵɵFactoryTarget.Component });
...
class IGridExpandableRow {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: IGridExpandableRow, isStandalone: true, selector: "i-grid-expandable-row", host: { attributes: { "role": "row" }, classAttribute: "i-grid-expandable-row flex" }, ngImport: i0, template: `<ng-content />`, isInline: true });
}
