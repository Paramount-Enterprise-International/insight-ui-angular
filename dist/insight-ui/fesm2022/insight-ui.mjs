...
import { NgClass, NgComponentOutlet, NgStyle, AsyncPipe, NgTemplateOutlet, CommonModule, formatDate } from '@angular/common';
import * as i0 from '@angular/core';
import { Input, Component, HostBinding, EventEmitter, booleanAttribute, HostListener, Output, ChangeDetectionStrategy, InjectionToken, Injectable, inject, Injector, Directive, NgModule, isDevMode, ViewChild, Optional, Self, ChangeDetectorRef, forwardRef, Pipe, ContentChild, ElementRef, TemplateRef, Host, ContentChildren } from '@angular/core';
...
import { Validators, NG_VALUE_ACCESSOR, FormBuilder, FormControl, ReactiveFormsModule, FormsModule, FormGroupDirective, NgControl } from '@angular/forms';
...
class IDialog {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.16", type: IDialog, isStandalone: true, selector: "i-dialog", inputs: { title: "title", actions: "actions", actionAlign: "actionAlign" }, outputs: { onOk: "onOk", onConfirm: "onConfirm", onSave: "onSave", onCustomAction: "onCustomAction" }, ngImport: i0, template: `@if (title) {
...
class IDialogModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.16", ngImport: i0, type: IDialogModule, imports: [IDialogContainer, IDialogOutlet, IDialogCloseDirective, IDialog], exports: [IDialogContainer, IDialogOutlet, IDialogCloseDirective, IDialog] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IDialogModule });
}
...
class IAlert {
  ...
  `, isInline: true, dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "component", type: IIcon, selector: "i-icon", inputs: ["icon", "size"] }, { kind: "component", type: IDialog, selector: "i-dialog", inputs: ["title", "actions", "actionAlign"], outputs: ["onOk", "onConfirm", "onSave", "onCustomAction"] }] });
}
...
class IFCTextArea {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IFCTextArea, deps: [{ token: i1.NgControl, optional: true, self: true }, { token: i1.FormGroupDirective, optional: true }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component });
...
class IFCInput {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IFCInput, deps: [{ token: i1.NgControl, optional: true, self: true }, { token: i1.FormGroupDirective, optional: true }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component });
...
class ISelectOptionDefDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ISelectOptionDefDirective, deps: [{ token: i0.TemplateRef }], target: i0.ɵɵFactoryTarget.Directive });
...
class ISelect {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ISelect, deps: [{ token: i0.ElementRef }, { token: i0.ChangeDetectorRef }, { token: i0.NgZone }], target: i0.ɵɵFactoryTarget.Component });
...
class IFCSelect {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IFCSelect, deps: [{ token: i1.NgControl, optional: true, self: true }, { token: i1.FormGroupDirective, optional: true }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component });
...
class IPaginator {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.16", type: IPaginator, isStandalone: true, selector: "i-paginator", inputs: { length: "length", pageIndex: "pageIndex", pageSize: "pageSize", pageSizeOptions: "pageSizeOptions" }, outputs: { pageChange: "pageChange" }, host: { classAttribute: "i-paginator" }, ngImport: i0, template: `
...
class ITruncatedTooltipDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ITruncatedTooltipDirective, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
...
class IGridHeaderCellDefDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IGridHeaderCellDefDirective, deps: [{ token: i0.TemplateRef }], target: i0.ɵɵFactoryTarget.Directive });
...
class IGridCellDefDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IGridCellDefDirective, deps: [{ token: i0.TemplateRef }], target: i0.ɵɵFactoryTarget.Directive });
...
class IGridRowDefDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IGridRowDefDirective, deps: [{ token: i0.TemplateRef }, { token: i0.ViewContainerRef }], target: i0.ɵɵFactoryTarget.Directive });
...
class IGridCell {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IGridCell, deps: [{ token: IGridColumn, host: true, optional: true }, { token: IGridCustomColumn, host: true, optional: true }, { token: IGrid, optional: true }], target: i0.ɵɵFactoryTarget.Component });
...
class IGridHeaderCell {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: IGridHeaderCell, deps: [{ token: i0.ElementRef }, { token: IGrid, optional: true }, { token: IGridColumn, host: true, optional: true }, { token: IGridCustomColumn, host: true, optional: true }], target: i0.ɵɵFactoryTarget.Component });
...
class IGrid {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.16", type: IGrid, isStandalone: true, selector: "i-grid", inputs: { dataSource: "dataSource", selectionMode: "selectionMode", tree: "tree", treeIndent: "treeIndent", treeColumn: "treeColumn", treeInitialExpandLevel: "treeInitialExpandLevel", showNumberColumn: ["showNumberColumn", "showNumberColumn", booleanAttribute] }, outputs: { selectionChange: "selectionChange", rowClick: "rowClick", rowExpandChange: "rowExpandChange", expandedRowsChange: "expandedRowsChange" }, host: { attributes: { "role": "table" }, classAttribute: "i-grid" }, queries: [{ propertyName: "expandableRowDef", first: true, predicate: IGridRowDefDirective, descendants: true }, { propertyName: "columnDefs", predicate: IGridColumn }, { propertyName: "customColumnDefs", predicate: IGridCustomColumn }], exportAs: ["iGrid"], usesOnChanges: true, ngImport: i0, template: `<div class="i-grid-viewport">
      <!-- HEADER -->
      @if (columns.length) {
        <i-grid-header-row>
...
class ISectionTabs {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.16", type: ISectionTabs, isStandalone: true, selector: "i-section-tabs", inputs: { selectedIndex: "selectedIndex", height: "height" }, outputs: { selectedIndexChange: "selectedIndexChange" }, queries: [{ propertyName: "tabs", predicate: ISectionTab }], ngImport: i0, template: `
...
class IUI {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.16", ngImport: i0, type: IUI, imports: [IAlert,
            IButton,
            ICardModule,
            ICodeViewerModule,
            IConfirm,
