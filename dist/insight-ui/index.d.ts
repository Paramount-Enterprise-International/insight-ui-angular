...
import { EventEmitter, Type, InjectionToken, OnChanges, Injector, SimpleChanges, OnInit, TemplateRef, AfterContentInit, OnDestroy, ElementRef, ChangeDetectorRef, NgZone, QueryList, PipeTransform } from '@angular/core';
...
declare class ICodeViewer {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ICodeViewer, "i-code-viewer", never, { "title": { "alias": "title"; "required": false; }; "language": { "alias": "language"; "required": false; }; "file": { "alias": "file"; "required": false; }; "code": { "alias": "code"; "required": false; }; "copy": { "alias": "copy"; "required": false; }; "wrap": { "alias": "wrap"; "required": false; }; "compact": { "alias": "compact"; "required": false; }; "lineNumbers": { "alias": "lineNumbers"; "required": false; }; "scroll": { "alias": "scroll"; "required": false; }; "height": { "alias": "height"; "required": false; }; "highlighter": { "alias": "highlighter"; "required": false; }; }, { "fileLoaded": "fileLoaded"; }, never, ["*"], true, never>;
...
declare class ICodeViewerModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<ICodeViewerModule, never, [typeof ICodeViewer, typeof i1.HttpClientModule], [typeof ICodeViewer]>;
