...
import { EventEmitter, OnInit, TemplateRef, AfterContentInit, OnDestroy, ElementRef, ChangeDetectorRef, NgZone, InjectionToken, Type, OnChanges, Injector, SimpleChanges, ViewContainerRef, QueryList, PipeTransform } from '@angular/core';
import { AbstractControl, NgControl, ControlValueAccessor, FormGroupDirective, FormBuilder, FormControl, FormGroup } from '@angular/forms';
...
declare class ICard implements OnInit {
    ...
    rel?: string | null;
    disabled: boolean;
    readonly cardClick: EventEmitter<MouseEvent>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ICard, "i-card", never, { "href": { "alias": "href"; "required": false; }; "routerLink": { "alias": "routerLink"; "required": false; }; "queryParams": { "alias": "queryParams"; "required": false; }; "fragment": { "alias": "fragment"; "required": false; }; "replaceUrl": { "alias": "replaceUrl"; "required": false; }; "skipLocationChange": { "alias": "skipLocationChange"; "required": false; }; "state": { "alias": "state"; "required": false; }; "target": { "alias": "target"; "required": false; }; "rel": { "alias": "rel"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; }, { "cardClick": "cardClick"; }, never, ["*"], true, never>;
}
...
declare class ICodeViewer {
    ...
    readonly fileLoaded: EventEmitter<{
        file: string;
        language: string;
    }>;
    loading: boolean;
...
declare class IPaginator {
    ...
    readonly pageChange: EventEmitter<IPaginatorState>;
...
declare class IGrid<T> implements AfterContentInit, OnChanges, OnDestroy {
    ...
    readonly selectionChange: EventEmitter<IGridSelectionChange<T>>;
    /** Emits on row click (before selection logic) */
    readonly rowClick: EventEmitter<T>;
    /** Expand events */
    readonly rowExpandChange: EventEmitter<{
        row: T;
        expanded: boolean;
    }>;
    readonly expandedRowsChange: EventEmitter<T[]>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IGrid<any>, "i-grid", ["iGrid"], { "dataSource": { "alias": "dataSource"; "required": false; }; "selectionMode": { "alias": "selectionMode"; "required": false; }; "tree": { "alias": "tree"; "required": false; }; "treeIndent": { "alias": "treeIndent"; "required": false; }; "treeColumn": { "alias": "treeColumn"; "required": false; }; "treeInitialExpandLevel": { "alias": "treeInitialExpandLevel"; "required": false; }; "showNumberColumn": { "alias": "showNumberColumn"; "required": false; }; }, { "selectionChange": "selectionChange"; "rowClick": "rowClick"; "rowExpandChange": "rowExpandChange"; "expandedRowsChange": "expandedRowsChange"; }, ["expandableRowDef", "columnDefs", "customColumnDefs", "columnGroupDefs"], never, true, never>;
    static ngAcceptInputType_showNumberColumn: unknown;
}
declare const I_GRID_DECLARATIONS: (typeof IGridHeaderCellDefDirective | typeof IGridRowDefDirective | typeof IGridExpandableRow | typeof IGridCell | typeof IGridHeaderCell)[];
...
declare class IHTitleBreadcrumbService {
    ...
    readonly breadcrumbsOverride: i0.WritableSignal<IHBreadcrumbItem[] | null>;
...
declare class IHContent {
    ...
    private readonly routeBreadcrumb$;
    /** override breadcrumbs (read from signals) */
    private readonly overrideBreadcrumb$;
...
declare class ISectionTabs implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ISectionTabs, "i-section-tabs", never, { "selectedIndex": { "alias": "selectedIndex"; "required": false; }; "height": { "alias": "height"; "required": false; }; }, { "selectedIndexChange": "selectedIndexChange"; }, ["tabs"], never, true, never>;
}
...
declare class IUI {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<IUI, never, [typeof IButton, typeof ICardModule, typeof ICodeViewerModule, typeof IDatepicker, typeof IFCDatepicker, typeof IDialogModule, typeof IGridModule, typeof IHContent, typeof IHSidebar, typeof IIcon, typeof IInputModule, typeof ILoading, typeof ISectionModule, typeof ISelect, typeof IFCSelect, typeof ITextArea, typeof IFCTextArea], [typeof IButton, typeof ICardModule, typeof ICodeViewerModule, typeof IDatepicker, typeof IFCDatepicker, typeof IDialogModule, typeof IGridModule, typeof IHContent, typeof IHSidebar, typeof IIcon, typeof IInputModule, typeof ILoading, typeof ISectionModule, typeof ISelect, typeof IFCSelect, typeof ITextArea, typeof IFCTextArea]>;
