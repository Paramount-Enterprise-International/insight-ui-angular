...
declare class ISectionTabHeader {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ISectionTabHeader, "i-section-tab-header", never, {}, {}, never, never, true, never>;
}
declare class ISectionTabContent {
    tpl: TemplateRef<any>;
    static ɵfac: i0.ɵɵFactoryDeclaration<ISectionTabContent, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<ISectionTabContent, "i-section-tab-content", never, {}, {}, never, never, true, never>;
}
declare class ISectionTab {
    el: ElementRef<HTMLElement>;
    headerTpl: ISectionTabHeader;
    contentTpl: ISectionTabContent;
    get title(): string;
    get opened(): boolean;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ISectionTab, "i-section-tab", never, {}, {}, ["headerTpl", "contentTpl"], ["i-section-tab-header", "i-section-tab-content"], true, never>;
}
