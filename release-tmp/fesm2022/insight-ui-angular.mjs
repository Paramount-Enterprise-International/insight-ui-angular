import { NgClass, NgComponentOutlet, NgStyle, NgForOf, AsyncPipe, formatDate, NgTemplateOutlet } from '@angular/common';
import * as i0 from '@angular/core';
import { Input, Component, HostBinding, EventEmitter, booleanAttribute, HostListener, Output, ChangeDetectionStrategy, InjectionToken, Injectable, inject, Injector, Directive, NgModule, ViewChild, forwardRef, Optional, Self, Pipe, ContentChild, TemplateRef, Host, ContentChildren } from '@angular/core';
...
class IIcon {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: IIcon, isStandalone: true, selector: "ic", inputs: { icon: "icon", size: "size" }, ngImport: i0, template: "<i [ngClass]=\"iconClass\"></i>", dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IIcon, decorators: [{
            type: Component,
            args: [{ selector: 'ic', imports: [NgClass], template: "<i [ngClass]=\"iconClass\"></i>" }]
        }], propDecorators: { icon: [{
                type: Input
            }], size: [{
                type: Input
...
class ILoading {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: ILoading, isStandalone: true, selector: "i-loading", inputs: { label: "label", light: "light" }, host: { properties: { "attr.light": "this.isLight" } }, ngImport: i0, template: "<div class=\"spinner-border spinner-border-sm\" role=\"status\" [class.light]=\"light\"></div>{{ label }}" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ILoading, decorators: [{
            type: Component,
            args: [{ selector: 'i-loading', imports: [], template: "<div class=\"spinner-border spinner-border-sm\" role=\"status\" [class.light]=\"light\"></div>{{ label }}" }]
...
class ICard {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: ICard, isStandalone: true, selector: "i-card", ngImport: i0, template: "<ng-content />" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ICard, decorators: [{
            type: Component,
            args: [{ selector: 'i-card', imports: [], template: "<ng-content />" }]
        }] });
...
class ITextArea {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: ITextArea, isStandalone: true, selector: "i-textarea", inputs: { placeholder: "placeholder", readonly: "readonly", rows: "rows", invalid: "invalid", value: "value", disabled: "disabled" }, host: { listeners: { "click": "handleHostClick()" } }, providers: [
        ...
        ], viewQueries: [{ propertyName: "textareaRef", first: true, predicate: ["textareaRef"], descendants: true }], ngImport: i0, template: "<!--\n  ITextarea\n  Version: 1.0.0\n-->\n\n<textarea\n  #textareaRef\n  [placeholder]=\"placeholder\"\n  [readonly]=\"readonly\"\n  [rows]=\"rows\"\n  [disabled]=\"isDisabled\"\n  [value]=\"value ?? ''\"\n  [attr.aria-invalid]=\"invalid ? 'true' : null\"\n  (input)=\"handleInput($event)\"\n  (blur)=\"handleBlur()\"></textarea>\n", changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ITextArea, decorators: [{
            type: Component,
            args: [{ selector: 'i-textarea', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush, providers: [
                        {
                            provide: NG_VALUE_ACCESSOR,
                            useExisting: ITextArea,
                            multi: true,
...
class IFCTextArea {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: IFCTextArea, isStandalone: true, selector: "i-fc-textarea", inputs: { label: "label", placeholder: "placeholder", readonly: "readonly", rows: "rows", errorMessage: "errorMessage", value: "value" }, providers: [
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => IFCTextArea),
                multi: true,
            },
        ], viewQueries: [{ propertyName: "innerTextarea", first: true, predicate: ITextArea, descendants: true }], ngImport: i0, template: `@if (label) {
...
class IInput {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: IInput, isStandalone: true, selector: "i-input", inputs: { type: "type", placeholder: "placeholder", autocomplete: "autocomplete", readonly: "readonly", invalid: "invalid", mask: "mask", value: "value", prepend: "prepend", append: "append", disabled: "disabled" }, host: { listeners: { "click": "handleHostClick($event)" } }, providers: [
        ...
        ], viewQueries: [{ propertyName: "inputRef", first: true, predicate: ["inputRef"], descendants: true }], ngImport: i0, template: "<!-- input.html -->\n<!--\n IInput\n Version: 2.0.0 (template)\n-->\n\n@for (i of prepends; track $index) {\n  <i-input-addon [addon]=\"i\" />\n}\n<input\n  #inputRef\n  [type]=\"type\"\n  [placeholder]=\"placeholder\"\n  [attr.autocomplete]=\"autocomplete || null\"\n  [readonly]=\"readonly\"\n  [disabled]=\"isDisabled\"\n  [value]=\"value ?? ''\"\n  [attr.aria-invalid]=\"invalid ? 'true' : null\"\n  [iInputMask]=\"mask\"\n  (input)=\"handleInput($event)\"\n  (blur)=\"handleBlur()\" />\n@for (i of appends; track $index) {\n  <i-input-addon [addon]=\"i\" />\n}\n", dependencies: [{ kind: "component", type: IInputAddon, selector: "i-input-addon", inputs: ["addon"] }, { kind: "directive", type: IInputMaskDirective, selector: "[iInputMask]", inputs: ["iInputMask"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IInput, decorators: [{
            type: Component,
            args: [{ selector: 'i-input', standalone: true, imports: [IInputAddon, IInputMaskDirective], changeDetection: ChangeDetectionStrategy.OnPush, providers: [
                        {
                            provide: NG_VALUE_ACCESSOR,
                            useExisting: forwardRef(() => IInput),
                            multi: true,
...
class IFCSelect {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: IFCSelect, isStandalone: true, selector: "i-fc-select", inputs: { label: "label", placeholder: "placeholder", options: "options", options$: "options$", displayWith: "displayWith", filterDelay: "filterDelay", filterPredicate: "filterPredicate", panelPosition: "panelPosition", errorMessage: "errorMessage", value: "value" }, providers: [
        ...
        ], viewQueries: [{ propertyName: "innerSelect", first: true, predicate: ISelect, descendants: true }], ngImport: i0, template: `@if (label) {
...
class IFCDatepicker {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: IFCDatepicker, isStandalone: true, selector: "i-fc-datepicker", inputs: { label: "label", placeholder: "placeholder", format: "format", panelPosition: "panelPosition", errorMessage: "errorMessage", value: "value" }, providers: [
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => IFCDatepicker),
                multi: true,
            },
        ], viewQueries: [{ propertyName: "innerDatepicker", first: true, predicate: IDatepicker, descendants: true }], ngImport: i0, template: `@if (label) {
...
class IPaginator {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: IPaginator, isStandalone: true, selector: "i-paginator", inputs: { length: "length", pageIndex: "pageIndex", pageSize: "pageSize", pageSizeOptions: "pageSizeOptions" }, outputs: { pageChange: "pageChange" }, ngImport: i0, template: "<!-- paginator.html -->\n\n<!--\n IPaginator\n Version: 1.1.0\n-->\n<div class=\"i-paginator flex align-items-center gap-2\">\n  <!-- <button\n    type=\"button\"\n    class=\"btn btn-sm btn-outline-secondary\"\n    (click)=\"previousPage()\"\n    [disabled]=\"pageIndex <= 0\">\n    \u2039\n  </button> -->\n  <i-button icon=\"prev\" (onClick)=\"previousPage()\" size=\"sm\" [disabled]=\"pageIndex <= 0\"></i-button>\n\n  <span>Page {{ pageIndex + 1 }} / {{ pageCount }}</span>\n\n  <!-- <button\n    type=\"button\"\n    class=\"btn btn-sm btn-outline-secondary\"\n    (click)=\"nextPage()\"\n    [disabled]=\"pageIndex >= pageCount - 1\">\n    \u203A\n  </button> -->\n\n  <i-button\n    icon=\"next\"\n    (onClick)=\"nextPage()\"\n    size=\"sm\"\n    [disabled]=\"pageIndex >= pageCount - 1\"\n  ></i-button>\n\n  <span class=\"ms-2\">\n    | Show\n    <select\n      class=\"form-select form-select-sm d-inline-block w-auto\"\n      [value]=\"pageSize\"\n      (change)=\"changePageSize($any($event.target).value)\"\n    >\n      @for (size of pageSizeOptions; track size) {\n        <option [value]=\"size\">{{ size }}</option>\n      }\n    </select>\n    per page ({{ length }} total)\n  </span>\n</div>\n", dependencies: [{ kind: "component", type: IButton, selector: "i-button", inputs: ["disabled", "loading", "type", "loadingText", "variant", "size", "icon"], outputs: ["onClick"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IPaginator, decorators: [{
            type: Component,
            args: [{ selector: 'i-paginator', standalone: true, imports: [IButton], template: "<!-- paginator.html -->\n\n<!--\n IPaginator\n Version: 1.1.0\n-->\n<div class=\"i-paginator flex align-items-center gap-2\">\n  <!-- <button\n    type=\"button\"\n    class=\"btn btn-sm btn-outline-secondary\"\n    (click)=\"previousPage()\"\n    [disabled]=\"pageIndex <= 0\">\n    \u2039\n  </button> -->\n  <i-button icon=\"prev\" (onClick)=\"previousPage()\" size=\"sm\" [disabled]=\"pageIndex <= 0\"></i-button>\n\n  <span>Page {{ pageIndex + 1 }} / {{ pageCount }}</span>\n\n  <!-- <button\n    type=\"button\"\n    class=\"btn btn-sm btn-outline-secondary\"\n    (click)=\"nextPage()\"\n    [disabled]=\"pageIndex >= pageCount - 1\">\n    \u203A\n  </button> -->\n\n  <i-button\n    icon=\"next\"\n    (onClick)=\"nextPage()\"\n    size=\"sm\"\n    [disabled]=\"pageIndex >= pageCount - 1\"\n  ></i-button>\n\n  <span class=\"ms-2\">\n    | Show\n    <select\n      class=\"form-select form-select-sm d-inline-block w-auto\"\n      [value]=\"pageSize\"\n      (change)=\"changePageSize($any($event.target).value)\"\n    >\n      @for (size of pageSizeOptions; track size) {\n        <option [value]=\"size\">{{ size }}</option>\n      }\n    </select>\n    per page ({{ length }} total)\n  </span>\n</div>\n" }]
...
class IGridModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.15", ngImport: i0, type: IGridModule, imports: [IGrid, IGridColumn, IGridCustomColumn, IGridHeaderCellDefDirective, IGridCellDefDirective, IGridHeaderCell, IGridCell, IGridHeaderRowDirective, IGridRowDirective, IPaginator], exports: [IGrid, IGridColumn, IGridCustomColumn, IGridHeaderCellDefDirective, IGridCellDefDirective, IGridHeaderCell, IGridCell, IGridHeaderRowDirective, IGridRowDirective, IPaginator] });
...
class ISectionCode {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ISectionCode, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: ISectionCode, isStandalone: true, selector: "i-section-code", inputs: { code: "code" }, ngImport: i0, template: ` <pre><code [innerText]="code"></code></pre> `, isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ISectionCode, decorators: [{
            type: Component,
            args: [{
...
class ISectionMarkdown {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ISectionMarkdown, deps: [{ token: i1$1.DomSanitizer }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.15", type: ISectionMarkdown, isStandalone: true, selector: "i-section-markdown", inputs: { markdown: "markdown", content: "content" }, ngImport: i0, template: ` <div class="i-section-markdown" [innerHTML]="rendered"></div> `, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ISectionMarkdown, decorators: [{
            type: Component,
            args: [{
        ...
        }], ctorParameters: () => [{ type: i1$1.DomSanitizer }, { type: i0.ChangeDetectorRef }], propDecorators: { markdown: [{
                type: Input
            }], content: [{
                type: Input
            }] } });
class ISectionModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.15", ngImport: i0, type: ISectionModule, imports: [ISection, ISectionHeader, ISectionSubHeader, ISectionFilter, ISectionBody, ISectionFooter, ISectionCode, ISectionMarkdown], exports: [ISection, ISectionHeader, ISectionSubHeader, ISectionFilter, ISectionBody, ISectionFooter, ISectionCode, ISectionMarkdown] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ISectionModule });
}
...
class IUI {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.15", ngImport: i0, type: IUI, imports: [IAlert,
            ...
            IFCSelect,
            ITextArea] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IUI, imports: [IConfirm,
            IDialogModule,
            IGridModule,
            IInputModule,
            ISectionModule, IDialogModule,
            IGridModule,
            IInputModule,
            ISectionModule] });
}
