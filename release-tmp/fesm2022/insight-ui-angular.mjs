...
import { Input, Component, HostBinding, EventEmitter, booleanAttribute, HostListener, Output, ChangeDetectionStrategy, InjectionToken, Injectable, inject, Injector, Directive, NgModule, ViewChild, Optional, Self, forwardRef, Pipe, ContentChild, TemplateRef, Host, ContentChildren } from '@angular/core';
...
class HighlightSearchPipe {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: HighlightSearchPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe });
    static ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "20.3.15", ngImport: i0, type: HighlightSearchPipe, isStandalone: true, name: "highlightSearch" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: HighlightSearchPipe, decorators: [{
            type: Pipe,
            args: [{
