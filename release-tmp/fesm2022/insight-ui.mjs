...
import { Input, Component, HostBinding, EventEmitter, booleanAttribute, HostListener, Output, ChangeDetectionStrategy, InjectionToken, Injectable, inject, Injector, Directive, NgModule, isDevMode, ViewChild, Optional, Self, forwardRef, Pipe, ContentChild, TemplateRef, Host, ContentChildren } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ICard, decorators: [{
            type: Component,
            args: [{ selector: 'i-card', standalone: true, imports: [RouterLink], changeDetection: ChangeDetectionStrategy.OnPush, template: "<a\n  class=\"i-card\"\n  [attr.href]=\"hrefAttr\"\n  [attr.target]=\"target ?? null\"\n  [attr.rel]=\"relAttr\"\n  [attr.aria-disabled]=\"disabled ? 'true' : null\"\n  [attr.tabindex]=\"disabled ? -1 : null\"\n  [routerLink]=\"routerLinkAttr\"\n  [queryParams]=\"queryParams\"\n  [fragment]=\"fragment\"\n  [replaceUrl]=\"replaceUrl\"\n  [skipLocationChange]=\"skipLocationChange\"\n  [state]=\"state\"\n  (click)=\"onClick($event)\"\n>\n  <ng-content />\n</a>\n" }]
        }], propDecorators: { href: [{
                type: Input
            }], routerLink: [{
                type: Input
