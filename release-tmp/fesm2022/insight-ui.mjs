...
class ICodeViewer {
    ...
    codeEl;
    projectedTpl; // TemplateRef<unknown> (kept any to avoid extra imports)
    // ===== Inputs =====
    title = '';
