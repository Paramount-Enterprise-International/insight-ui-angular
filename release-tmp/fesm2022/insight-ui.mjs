...
function resolveFileUrl(file) {
    ...
    const base = import.meta.url; // ESM
...
function detectGlobalHighlighter() {
    const w = globalThis;
    if (w?.hljs?.highlight && w?.hljs?.highlightAuto)
        return { kind: 'hljs', api: w.hljs };
    if (w?.Prism?.highlight && w?.Prism?.languages)
        return { kind: 'prism', api: w.Prism };
...
class ICodeViewer {
    ...
    renderToHtml(raw, language) {
        ...
        const mode = this.highlighter === 'auto'
            ? detected.kind
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: ICodeViewer, isStandalone: true, selector: "i-code-viewer", inputs: { title: "title", language: "language", file: "file", code: "code", copy: ["copy", "copy", coerceBool], lineNumbers: ["lineNumbers", "lineNumbers", coerceBool], wrap: ["wrap", "wrap", coerceBool], compact: ["compact", "compact", coerceBool], scroll: ["scroll", "scroll", coerceBool], height: "height", highlighter: "highlighter" }, outputs: { fileLoaded: "fileLoaded" }, viewQueries: [{ propertyName: "codeEl", first: true, predicate: ["codeEl"], descendants: true }], ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ICodeViewer, decorators: [{
  ...
  `,
        ...
        }], propDecorators: { codeEl: [{
                type: ViewChild,
                args: ['codeEl', { static: false }]
            }], title: [{
                type: Input
            }], language: [{
                type: Input
