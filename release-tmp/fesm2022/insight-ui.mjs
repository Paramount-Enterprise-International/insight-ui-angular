...
import { Input, Component, HostBinding, EventEmitter, booleanAttribute, HostListener, Output, ChangeDetectionStrategy, isDevMode, NgModule, inject, ChangeDetectorRef, ViewChild, Directive, forwardRef, Pipe, TemplateRef, ElementRef, NgZone, ContentChild, InjectionToken, Injectable, Injector, ViewContainerRef, ContentChildren, signal, ViewChildren } from '@angular/core';
...
class ISectionTabHeader {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ISectionTabHeader, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.16", type: ISectionTabHeader, isStandalone: true, selector: "i-section-tab-header", ngImport: i0 });
}
...
class ISectionTabContent {
    // ✅ prefer inject() over constructor injection
    tpl = inject(TemplateRef);
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ISectionTabContent, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.16", type: ISectionTabContent, isStandalone: true, selector: "i-section-tab-content", ngImport: i0 });
}
...
class ISectionTab {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.16", type: ISectionTab, isStandalone: true, selector: "i-section-tab", queries: [{ propertyName: "headerTpl", first: true, predicate: ISectionTabHeader, descendants: true }, { propertyName: "contentTpl", first: true, predicate: ISectionTabContent, descendants: true }], ngImport: i0, template: `
    <ng-template>
...
class ISectionTabs {
    ...
    ngAfterContentInit() {
        const sync = () => {
            ...
            // - first opened tab
            // - else 0
            const next = this.selectedIndex !== null && this.selectedIndex !== undefined
                ? this.selectedIndex
                : openedIndex >= 0
                    ? openedIndex
                    : 0;
...
class ISectionModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.16", ngImport: i0, type: ISectionModule, imports: [CommonModule, ISection, ISectionHeader, ISectionSubHeader, ISectionFilter, ISectionBody, ISectionFooter, ISectionTabs, ISectionTab, ISectionTabHeader, ISectionTabContent], exports: [ISection, ISectionHeader, ISectionSubHeader, ISectionFilter, ISectionBody, ISectionFooter, ISectionTabs, ISectionTab, ISectionTabHeader, ISectionTabContent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ISectionModule, imports: [CommonModule,
            ISectionTabs] });
}
